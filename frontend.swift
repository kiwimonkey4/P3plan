...
let url = URL(string: "http://192.168.50.235:8000/")! // This URL is where the backend server is located. Must be on same network to use this for now 
...
sendImage(file_path: "/home/avir/swift-projects/cinnamon.jpg")
RunLoop.main.run()
